<?php 
	...
	$canalTable = DB::table('matanzabovinos')->where('matanzabovinos.id','=', $entry)
	->join('establecimientosdestino', 'matanzabovinos.destino_id', '=', 'establecimientosdestino.id')
	->selecT('establecimientosdestino.propietario as cliente', 'matanzabovinos.canal as canal', 'matanzabovinos.sexo as sexo', 'matanzabovinos.pesoCanal as peso')->first();
