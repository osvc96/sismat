...
class MatanzaPorcinoCrudController extends CrudController
{
    ...
    public function setUp()
    {
		...
		*/
        ...
        $this->crud->setColumns(
            [
                ...
                [
                   ...
                   'type' => "select",
                   'name' => 'destino_id', // the column that contains the ID of that connected entity;
                ...
                [
                    ...
                    'label' => "Grasa" // Table column heading
                ],
                [
        ...
        // $this->crud->groupBy();
        // $this->crud->limit();
        $this->crud->addButtonFromView('line', 'Imprimir Boleta', 'exportCanalP', 'beginning');
    }
