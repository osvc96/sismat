...
class MatanzaBovinoCrudController extends CrudController
{
    ...
    public function setUp()
    {
		...
		*/
        ...
        $this->crud->setEntityNameStrings('Canal', 'Canales de bovinos');
		...
		*/
        ...
        $this->crud->setColumns(
            [
                ...
                [
                    'name' => 'propietarioDestino', // The db column name
                ...
                [
                    'name' => 'prenada', // The db column name
                    'label' => "Preñada" // Table column heading
                ],
                [
        ...
        $this->crud->addFields(
            [
                ...
                [ // select_from_array
                    ...
                    'label' => "Preñada",
                    'type' => 'select_from_array',
                    'options' => ['No' => 'No', 'Pequeño' => 'Pequeño', 'Mediano' => 'Mediano', 'Grande' => 'Grande'],
                    'allows_null' => false,
                    // 'allows_multiple' => true, // OPTIONAL; needs you to cast this to array in your model;
                ]
            ], 'update/create/both');
        ...
        //$this->crud->allowAccess('canal_details_row');
    ...
    {
        $this->crud->hasAccessOrFail('canal_details_row');

        $detalle = DB::table('ingresosubastas')
            ->join('matanzasubastas', 'ingresosubastas.id', '=', 'matanzasubastas.ingreso_id')
            ->select('ingresosubastas.*')
            ->where('matanzasubastas.id', '=', $id)
            ->first();

        // load the view from /resources/views/vendor/backpack/crud/ if it exists, otherwise load the one in the package
        return view('crud::canal_details_row', ['values' => $detalle]);
    }
}
