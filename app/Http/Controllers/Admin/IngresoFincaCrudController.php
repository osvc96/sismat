...
class IngresoFincaCrudController extends CrudController
{
    ...
    public function setUp()
    {
		...
		*/
        ...
        $this->crud->setEntityNameStrings('ingreso', 'Ingresos con guía de finca');
		...
		*/
        ...
        $this->crud->addFields([
            ...
            [
                 ...
                 'label' => "Propietario", // Table column heading
                 'type' => "select2",
                 'name' => 'propietario_id', // the method that defines the relationship in your Model
                 'entity' => 'propietario', // the method that defines the relationship in your Model
