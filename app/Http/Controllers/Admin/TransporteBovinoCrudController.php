...
use App\Http\Requests\TransporteBovinoRequest as StoreRequest;
use App\Http\Requests\TransporteBovinoRequest as UpdateRequest;

class TransporteBovinoCrudController extends CrudController
{
    ...
    public function setUp()
    {
		...
		|--------------------------------------------------------------------------
		*/
        $this->crud->setModel("App\Models\TransporteBovino");
        $this->crud->setRoute("admin/transporteBovino");
        $this->crud->setEntityNameStrings('transportebovino', 'transportebovinos');
        ...
        $this->crud->setColumns(
            [
                ...
                [       // SelectMultiple = n-n relationship (with pivot table)
                    ...
                    'name' => 'canales', // the method that defines the relationship in your Model
                    'entity' => 'canales', // the method that defines the relationship in your Model
